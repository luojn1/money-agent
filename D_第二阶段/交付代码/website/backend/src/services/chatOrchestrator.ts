...
export class ChatError extends Error {
  constructor(
    public readonly code: "TASK_NOT_FOUND" | "RESULT_NOT_READY" | "EMPTY_MESSAGE",
    message: string,
  ) {
    super(message);
    this.name = "ChatError";
...
const LLM_SYSTEM_PROMPT = [
  ...
  "- 标点规范，禁止连续句号；不复述用户问题；不罗列法条原文，只说结论和出处名称。",
  "",
  "# 立场与合规",
...
/** 仅供测试：清空某任务历史。 */
export const resetChatHistory = (taskId: string) => histories.delete(taskId);
