...
def build_risk_rules() -> list[dict[str, Any]]:
    items = [
        ...
        ("提前还款收手续费", "prepayment", {"field": "data.contractSummary.prepaymentRule", "operator": "contains_any", "value": ["手续费", "提前结清费"]}, "medium", 15, "《民法典》第677条", "请机构说明提前结清费用计算方式和已收费用退还规则。"),
        ...
        ("提前还款需审批", "prepayment", {"field": "data.contractSummary.prepaymentRule", "operator": "contains_any", "value": ["需审批", "经同意", "申请通过"]}, "medium", 10, "《民法典》第677条", "请机构说明审批标准、处理时限和拒绝提前还款的依据。"),
        ...
        ("单方变更条款", "dispute_resolution", {"clauses_contains_any": ["有权单方调整", "无需另行通知", "平台可变更"]}, "high", 20, "《民法典》第497条；《消费者权益保护法》第26条", "请机构说明哪些内容可单方变更，以及消费者是否有拒绝或解除权。"),
        ...
        ("征信授权范围过宽", "authorization_privacy", {"clauses_contains_any": ["征信授权", "报送征信", "查询征信"]}, "high", 20, "《征信业管理条例》；《个人信息保护法》", "请机构说明征信查询和报送的目的、范围、期限及撤回方式。"),
        ("信息共享范围过宽", "authorization_privacy", {"clauses_contains_any": ["关联公司共享", "合作伙伴共享", "第三方共享"]}, "high", 20, "《个人信息保护法》第13条、第23条", "请机构列明共享对象、目的、字段和用户拒绝方式。"),
        ...
        ("个人信息保存期限不明", "authorization_privacy", {"clauses_contains_any": ["长期保存", "永久保存", "保存期限"]}, "medium", 10, "《个人信息保护法》第19条", "请机构说明个人信息保存期限和删除路径。"),
        ("营销授权默认同意", "authorization_privacy", {"clauses_contains_any": ["营销短信", "商业推广", "默认同意"]}, "low", 8, "《个人信息保护法》；《消费者权益保护法》", "请机构说明营销授权是否可单独拒绝和撤回。"),
        ("催收联系人披露", "overdue", {"clauses_contains_any": ["联系紧急联系人", "通知亲友", "联系单位"]}, "high", 20, "金融消费者权益保护和催收行为规范", "请机构说明逾期催收是否会向无关第三人披露债务信息。"),
        ("暴力催收或威胁性措辞", "overdue", {"clauses_contains_any": ["上门施压", "公开曝光", "威胁", "骚扰"]}, "high", 24, "《个人信息保护法》；金融催收自律规范", "请机构承诺不得骚扰、威胁或向无关人员披露信息。"),
        ("催收费用另收", "overdue", {"clauses_contains_any": ["催收费", "外访费", "催告费"]}, "medium", 12, "《民法典》第585条；金融消费者权益保护规则", "请机构说明催收费用的合法依据和计算上限。"),
